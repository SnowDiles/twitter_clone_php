...
<body data-theme="my-custom-theme">
  <div class="flex flex-col items-center">
    <div class="max-w-xl justify-self-center w-full h-[54px] px-4 items-center flex gap-5">
      <a href="">
      ...
      <div class="flex flex-col">
        <span>Augustin Ver</span>
        <span class="text-xs text-tertiary-500">12 posts</span>
      </div>
    </div>
    <div class="max-w-xl justify-self-center w-full">
      <div class="border-b border-white">
  
        <div>
          <img src="../../assets/userid_1500x500.png" alt="profile banner" class="h-full w-full">
        </div>
        ...
        <div>
          <div class="flex items-center justify-between px-3">
            ...
            <div class="flex">
              <?php if (isset($_SESSION['user']) && $_SESSION['user'] == 'userid') { ?>
                <button class="btn variant-ringed-secondary mt-3 invert dark:invert-0">
                  Editer le profile
                </button>
              <?php } else {?>
              ...
              <button class="btn variant-filled-secondary mt-3 font-bold invert dark:invert-0">Suivre</button>
              <?php } ?>
            </div>
          </div>
  
          <div class="px-3 flex flex-col mb-3">
            <span class="font-bold">Augustin Ver</span>
            <span class="text-xs text-tertiary-500">@gusssss</span>
          </div>
  
          <div class="mx-3 mb-3">
            <p>J'en parlerais dans mon livre.</p>
          </div>
