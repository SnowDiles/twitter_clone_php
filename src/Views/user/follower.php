...
<body data-theme="my-custom-theme" class="flex">
    <div class="md:hidden min-h-screen flex flex-col w-full">
        <div class="flex-1 pb-16 md:pb-0">
            ...
            <!-- Liste des abonnées à faire dynamiquement -->
            <div class="px-4">
    ...
    <div class="hidden md:flex min-h-screen w-full flex-[4]">
        <div class="flex-1 flex flex-col md:max-w-xl border-r border-gray-500">

            <div class="flex items-center p-4 border-b border-gray-500">
